...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0x0B, LEVEL_TTM, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C, LEVEL_HMC, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x20, LEVEL_CASTLE, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x30, LEVEL_ENDING, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_YELLOW_COIN, -15181, 2255, 6, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_CASTLE_WOODEN_DOOR, -13193, 888, 143, 0, 90, 0, 0x04000000, bhvDoor),
		OBJECT(MODEL_NONE, -13390, 869, 149, 0, 0, 0, 0x10300000, bhvWarp),
		MARIO_POS(0x01, 0, 1142, 200, 0),
		OBJECT(MODEL_NONE, -15345, 2361, 18, 0, 90, 0, 0x009E0000, bhvSignOnWall),
