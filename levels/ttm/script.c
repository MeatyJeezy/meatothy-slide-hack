...
const LevelScript level_ttm_entry[] = {
	...
	AREA(1, ttm_area_1),
		...
		OBJECT(MODEL_LAUNCH_BARREL, 23959, 8842, 11208, -5, -108, 30, 0x004E0000, bhvLaunchBarrel),
		...
		OBJECT(MODEL_LAUNCH_BARREL, -402, 5412, 13323, 90, -5, 0, 0x00AF0000, bhvLaunchBarrel),
		OBJECT(MODEL_LAUNCH_BARREL, 747, 7172, 3791, 4, -54, 12, 0x003F0000, bhvLaunchBarrel),
		OBJECT(MODEL_LAUNCH_BARREL, -443, -27, 13191, -55, -126, 0, 0x00820000, bhvLaunchBarrel),
		...
		OBJECT(MODEL_LAUNCH_BARREL, -413, 666, 14014, -69, -139, -1, 0x00AF0000, bhvLaunchBarrel),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -10316, 5527, -14473, 0, -90, 0, 0x00A70000, bhvMessagePanel),
		OBJECT(MODEL_NONE, 20390, 9003, -407, 0, 0, 0, 0x00000000, bhvFallingLeaves),
		OBJECT(MODEL_NONE, 16114, 6908, -5101, 0, 0, 0, 0x00000000, bhvFallingLeaves),
		OBJECT(MODEL_NONE, 14601, 4280, 13225, 0, 0, 0, 0x00000000, bhvFallingLeaves),
		OBJECT(MODEL_NONE, 7716, 7299, 14234, 0, 0, 0, 0x00000000, bhvFallingLeaves),
		OBJECT(MODEL_NONE, 11236, 5554, 8954, 0, 0, 0, 0x00000000, bhvFallingLeaves),
		OBJECT(MODEL_NONE, -878, 8449, 7271, 0, 0, 0, 0x00000000, bhvFallingLeaves),
		MARIO_POS(0x01, 0, 29447, 10119, 971),
		OBJECT(MODEL_NONE, 30293, 10216, 12, 0, -90, 0, 0x000B0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_STAR, -11520, 6071, -14817, 0, 0, 0, 0x01000000, bhvStar),
		OBJECT(MODEL_NONE, 29447, 9831, 971, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
