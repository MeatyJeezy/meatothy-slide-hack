...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_LAUNCH_BARREL, 9037, -2299, -11840, 0, 0, 0, 0x00000000, bhvLaunchBarrel),
		...
		MARIO_POS(0x01, 0, 9428, 8710, -13819),
		OBJECT(MODEL_NONE, 9362, 8622, -13819, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
