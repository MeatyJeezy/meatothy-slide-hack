...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		WARP_NODE(0x0E, LEVEL_BOB, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -10275, 5521, -14781, 0, 0, 0, 0x000E0000, bhvWarpPipe),
		MARIO_POS(0x01, 0, 29267, 10119, -22),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 29753, 9596, 110, 0, 0, 0, 0x000B0000, bhvWarpPipe),
