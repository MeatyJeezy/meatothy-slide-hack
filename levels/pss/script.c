...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_BOUNCE_SHROOM, 1199, 4387, -12097, 27, 90, 0, 0x12600000, bhvBounceShroom),
		OBJECT(MODEL_BOUNCE_SHROOM, 2267, 5512, -12097, 61, -90, 0, 0x10600000, bhvBounceShroom),
		...
		OBJECT(MODEL_LAUNCH_BARREL, -9523, 5917, -11983, 7, -39, 0, 0x00500000, bhvLaunchBarrel),
