...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_NONE, -23724, 1483, 23646, 0, 0, 0, 0x00000000, bhvSmallSnake),
		OBJECT(MODEL_NONE, -16784, 1068, 16501, 0, 0, 0, 0x00000000, bhvSmallSnake),
		OBJECT(MODEL_NONE, -12014, -413, 11610, 0, 0, 0, 0x00000000, bhvSmallSnake),
		...
		OBJECT(MODEL_WATER_WHEEL, -17844, 5433, -8281, 0, 0, 0, 0x00000000, bhvWaterWheel),
