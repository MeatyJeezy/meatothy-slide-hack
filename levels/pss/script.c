...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, -21733, 4773, 20826, 0, 0, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -21494, 4732, 20826, 0, 0, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -21319, 4695, 20826, 0, 0, 0, 0x00000000, bhvBreakableBox),
		MARIO_POS(0x01, 0, -30452, 8105, 20907),
		...
		OBJECT(MODEL_NONE, -30452, 8105, 20810, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
