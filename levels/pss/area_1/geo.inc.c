...
const GeoLayout pss_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -24537, 4037, 2703, 0, 89, 6, pss_dl_caveramp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -17441, 1533, 17754, 0, 45, 0, pss_dl_caveslope_001_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -32824, 0, -58, 0, -90, 0, pss_dl_edge2_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -23708, 4037, -4840, 0, 70, 6, pss_dl_ramp_002_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -7800, 5500, -12000, 0, 0, 6, pss_dl_ramp_003_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -24537, 4037, -1299, 0, 89, 6, pss_dl_ramp_004_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -28182, 2815, 25110, 30, -135, 0, pss_dl_slantedcave_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -31013, 2815, 25512, 30, 45, 0, pss_dl_slantedcave_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -31416, 2815, 27729, 30, 135, 0, pss_dl_slantedcave_002_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -23443, 3971, 18598, 30, -90, 0, pss_dl_slantedcave_003_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -27899, 3971, 18442, 30, 90, 0, pss_dl_slantedcave_004_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -29698, 722, 25169, 0, -45, 0, pss_dl_slantedcavefailsafe_mesh_layer_1),
