...
const GeoLayout pss_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 47, -7206, -159, pss_dl_deathplane_mesh_layer_5),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -20830, 9680, 19002, 0, 180, -6, pss_dl_slide1_013_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -20830, 9680, 17557, 0, 180, -6, pss_dl_slide1_015_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -20830, 9680, 16110, 0, 180, -6, pss_dl_slide1_016_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -20830, 9680, 14684, 0, 180, -6, pss_dl_slide1_017_mesh_layer_1),
