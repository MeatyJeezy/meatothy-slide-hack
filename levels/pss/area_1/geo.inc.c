...
const GeoLayout pss_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 10342, 1430, -1561, 0, 29, 0, pss_dl_failplat_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -515, -1719, 0, pss_dl_STARTLINE_mesh_layer_1),
