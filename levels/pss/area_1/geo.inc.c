...
const GeoLayout pss_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -24035, 6657, 13114, 0, 140, 0, pss_dl_angledcavewall_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -26870, 5839, 13334, 0, 140, 0, pss_dl_angledcavewall_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -24537, 4037, 2703, 0, 89, 6, pss_dl_caveramp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -24106, 3533, 12780, 0, 0, -5, pss_dl_caveslope_mesh_layer_1),
