...
void scroll_hmc_dl_Water_002_mesh_layer_1_vtx_1() {
	int i = 0;
	int count = 8;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	float frequencyY = 0.0700000524520874;
	float offsetY = 0.29999998211860657;
	Vtx *vertices = segmented_to_virtual(hmc_dl_Water_002_mesh_layer_1_vtx_1);
...
void scroll_hmc() {
	...
	scroll_hmc_dl_Water_002_mesh_layer_1_vtx_1();
};
