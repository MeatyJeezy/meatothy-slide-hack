...
const GeoLayout hmc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_boulderaccelplane_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_boulderaccelplane_001_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_boulderaccelplane_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_boulderaccelplane_003_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, hmc_dl_deathplane_mesh_layer_5),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_rollingrockplane_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_slide2_011_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_slide2_012_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_slide2_013_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_wallkickrocks_mesh_layer_1),
