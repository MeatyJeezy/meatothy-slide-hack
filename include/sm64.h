...
enum MarioFlags {
    ...
    MARIO_DID_BLJ             = /* 0x00000200 */ (1 <<  9), // NEW for use if a BLJ is detected.
...
// NEW Landing after Launch Barrel: ACT_SLIDE_ROLL
#define ACT_SLIDE_ROLL                 0x00840458 // (0x058 | ACT_FLAG_MOVING | ACT_FLAG_BUTT_OR_STOMACH_SLIDE | ACT_FLAG_ATTACKING)
...
// NEW ACT_SHOT_FROM_LAUNCH_BARREL
#define ACT_SHOT_FROM_LAUNCH_BARREL    0x00800897 // (0x097 | ACT_FLAG_AIR | ACT_FLAG_ATTACKING)
...
// NEW ACT_IN_LAUNCH_BARREL
#define ACT_IN_LAUNCH_BARREL           0x00001373 // (0x173 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
