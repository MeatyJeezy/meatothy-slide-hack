COURSE_ACTS(COURSE_BOB, _("   @FF3030FFSUBSCRIBE!?"),
       _("WHAT DOES THIS MEAN?")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
...
COURSE_ACTS(COURSE_BBH, _("   WELCOME TO @FF0000FFG@00FF00FFB@0000FFFFJ"),
       _("lol")            , _("RIDE BIG BOO'S MERRY-GO-ROUND") , _("SECRET OF THE HAUNTED BOOKS"),
       _("SEEK THE 8 RED COINS")          , _("BIG BOO'S BALCONY")             , _("EYE TO EYE IN THE SECRET ROOM"))

COURSE_ACTS(COURSE_HMC, _("    RAVINE"),
       _("@F0F030FFCLEAR IN 2 MIN")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD MARIO CAN MOVE!"),
...
COURSE_ACTS(COURSE_TTM, _("   JUNGLE VILLAGE"),
       _("@F0F030FFCLEAR IN 1 MIN")            , _("MYSTERY OF THE MONKEY CAGE")    , _("SCARY 'SHROOMS, RED COINS"),
...
CASTLE_SECRET_STARS(_("          @009CB8FFHUB"))
